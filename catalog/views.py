...
def index(request):
    ...
    #generate counts of books with particular word
    word = 'du'
...
class TotalBooksListView(PermissionRequiredMixin,generic.ListView):
    """librarian class-based view listing all books."""
